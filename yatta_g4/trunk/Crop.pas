...
begin
  //TrackBar.Max := Form1.TrackBar1.Max;  fix me
...
begin
  FullFrame(TrackBar.Position, Project.Video.RGB32Video, CFP);
...
begin
  if Button = mbLeft then
    TrackBar.Position := MatchForm.FrameTrackBar.Position
  else if Button = mbRight then
    MatchForm.FrameTrackBar.Position := TrackBar.Position;
end;
